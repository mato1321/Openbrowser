...
mod tests {
    ...
    fn test_har_from_empty_log() {
        ...
        assert_eq!(har.log.creator.name, "OpenBrowser");
    }
    ...
    fn test_har_request_headers_populated() {
        ...
        r.request_headers.push(("user-agent".into(), "OpenBrowser/1.0".into()));
        r.response_headers.push(("content-type".into(), "text/html".into()));
        ...
        assert_eq!(entry.request.headers[1].value, "OpenBrowser/1.0");
