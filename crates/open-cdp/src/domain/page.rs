    ...
    async fn handle(
        ...
        match method {
            ...
            "captureScreenshot" => {
                #[cfg(feature = "screenshot")]
                {
                    ...
                    let screenshot_format = match format_str {
                        "jpeg" => open_core::screenshot::ScreenshotFormat::Jpeg {
                            quality: quality.unwrap_or(85),
                        },
                        _ => open_core::screenshot::ScreenshotFormat::Png,
                    };
                ...
                #[cfg(not(feature = "screenshot"))]
                {
                    HandleResult::Error(CdpErrorResponse {
                        ...
                        error: CdpErrorBody {
                            ...
                            message: "Screenshots not supported. OpenBrowser is a semantic-only \
            ...
            "printToPDF" => HandleResult::Error(CdpErrorResponse {
                ...
                error: CdpErrorBody {
                    code: crate::error::SERVER_ERROR,
                    message: "PDF generation not supported. OpenBrowser is a semantic-only \
