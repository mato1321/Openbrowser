...
An AI agent that uses open-browser for web navigation via OpenAI function calling.
...
Or create config file at `~/.open-agent/config.json`:
```json
{
...
- open-browser installed and in PATH
